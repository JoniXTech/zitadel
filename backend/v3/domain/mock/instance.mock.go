...
func (m *MockInstanceRepository) SetManagementConsoleAppID(arg0 string) database.Change {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetManagementConsoleAppID", arg0)
	ret0, _ := ret[0].(database.Change)
	return ret0
}

// SetManagementConsoleAppID indicates an expected call of SetManagementConsoleAppID.
func (mr *MockInstanceRepositoryMockRecorder) SetManagementConsoleAppID(arg0 any) *MockInstanceRepositorySetManagementConsoleAppIDCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetManagementConsoleAppID", reflect.TypeOf((*MockInstanceRepository)(nil).SetManagementConsoleAppID), arg0)
...
func (m *MockInstanceRepository) SetManagementConsoleClientID(arg0 string) database.Change {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetManagementConsoleClientID", arg0)
	ret0, _ := ret[0].(database.Change)
	return ret0
}

// SetManagementConsoleClientID indicates an expected call of SetManagementConsoleClientID.
func (mr *MockInstanceRepositoryMockRecorder) SetManagementConsoleClientID(arg0 any) *MockInstanceRepositorySetManagementConsoleClientIDCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetManagementConsoleClientID", reflect.TypeOf((*MockInstanceRepository)(nil).SetManagementConsoleClientID), arg0)
