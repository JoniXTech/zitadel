...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SystemDisableUserSelfService, eventstore.GenericEventMapper[SetEvent[bool]])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceDisableUserSelfService, eventstore.GenericEventMapper[SetEvent[bool]])
}
